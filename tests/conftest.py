...
def step7_context_budget():
    ...
    return ContextBudget(agent_name="TestAgent", token_limit=50, alert_threshold=0.80, strategy="sliding")
...
def step7_large_history():
    ...
    for i in range(10):
        msgs.append(HumanMessage(content=f"I want to book a table for {i+1} people at 7pm on Saturday"))
        msgs.append(AIMessage(content=f"Sure! I can book a table for {i+1} people. Please confirm your name."))
    return msgs
